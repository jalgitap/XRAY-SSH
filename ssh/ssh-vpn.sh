...
# ==================================================
# Link Hosting Kalian
akbarvpn="sc1.asle.me/ssh"

# Link Hosting Kalian Untuk Xray
akbarvpnn="sc1.asle.me/xray"

# Link Hosting Kalian Untuk Stunnel5
akbarvpnnnn="sc1.asle.me/stunnel5"
...
wget --no-check-certificate https://sc1.asle.me/ssh/vnstat-2.6.tar.gz
...
wget -O cf-pointing "--no-check-certificate https://sc1.asle.me/menu/cloudflare-pointing.sh"
wget -O cf-setting "--no-check-certificate https://sc1.asle.me/menu/cloudflare-setting.sh"
wget -O ins-xray "--no-check-certificate https://sc1.asle.me/xray/ins-xray.sh"
wget -O menu "--no-check-certificate https://sc1.asle.me/menu/menu.sh"
wget -O backup "--no-check-certificate https://sc1.asle.me/backup/gdrive.sh"
wget -O bkp "--no-check-certificate https://sc1.asle.me/backup/autobackup.sh"
wget -O menu-ssh "--no-check-certificate https://sc1.asle.me/menu/function-ssh.sh"
wget -O menu-trgo "--no-check-certificate https://sc1.asle.me/menu/function-trgo.sh"
wget -O menu-vmess "--no-check-certificate https://sc1.asle.me/menu/function-vmess.sh"
wget -O license "--no-check-certificate https://sc1.asle.me/menu/license.sh"
chmod +x cf-pointing
chmod +x cf-setting
chmod +x banner
chmod +x stat
