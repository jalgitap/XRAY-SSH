...
wget http://sc1.asle.me/ssh/vnstat-2.6.tar.gz
...
wget -O cf-pointing "http://sc1.asle.me/menu/cloudflare-pointing.sh"
wget -O cf-setting "http://sc1.asle.me/menu/cloudflare-setting.sh"
wget -O ins-xray "http://sc1.asle.me/xray/ins-xray.sh"
wget -O menu "http://sc1.asle.me/menu/menu.sh"
wget -O backup "http://sc1.asle.me/backup/gdrive.sh"
wget -O bkp "http://sc1.asle.me/backup/autobackup.sh"
wget -O menu-ssh "http://sc1.asle.me/menu/function-ssh.sh"
wget -O menu-trgo "http://sc1.asle.me/menu/function-trgo.sh"
wget -O menu-vmess "http://sc1.asle.me/menu/function-vmess.sh"
wget -O license "http://sc1.asle.me/menu/license.sh"
chmod +x cf-pointing
chmod +x cf-setting
chmod +x banner
chmod +x stat
