...
wget https://sc1.asle.me/ssh/vnstat-2.6.tar.gz
...
wget -O cf-pointing "https://sc1.asle.me/menu/cloudflare-pointing.sh"
wget -O cf-setting "https://sc1.asle.me/menu/cloudflare-setting.sh"
wget -O ins-xray "https://sc1.asle.me/xray/ins-xray.sh"
wget -O menu "https://sc1.asle.me/menu/menu.sh"
wget -O backup "https://sc1.asle.me/backup/gdrive.sh"
wget -O bkp "https://sc1.asle.me/backup/autobackup.sh"
wget -O menu-ssh "https://sc1.asle.me/menu/function-ssh.sh"
wget -O menu-trgo "https://sc1.asle.me/menu/function-trgo.sh"
wget -O menu-vmess "https://sc1.asle.me/menu/function-vmess.sh"
wget -O license "https://sc1.asle.me/menu/license.sh"
chmod +x cf-pointing
chmod +x cf-setting
chmod +x banner
chmod +x stat
